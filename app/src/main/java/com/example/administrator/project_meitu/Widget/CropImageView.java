...
/**
 * @param 详情请查看博客：http://blog.csdn.net/qq_21983189/article/details/52502795
 */
...
public class CropImageView extends View {
    ...
    public void setX_image(int x_image) {
        this.x_image = x_image;
    }

    public void setY_image(int y_image) {
    ...
    protected void checkBounds() {
        ...
        if (mDrawableFloat.left < (getLeft() - x_image)) {
            newLeft = getLeft() - x_image;
            isChange = true;
        }

        if (mDrawableFloat.top < (getTop() - y_image)) {
            newTop = getTop() - y_image;
            isChange = true;
        }
